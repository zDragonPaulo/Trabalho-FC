...
da cibersegurança, entre outros tópicos lecionados pelo professor Rogério Bravo. As respostas serão baseadas nos slides 
das aulas (\cite{slide_aula}) e vídeos (\cite{video_aula}).
