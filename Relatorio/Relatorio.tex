...
\subsection{Pergunta - Apresentação de duas áreas do MITRE ATT\&CK}
...
proteção não é infalível, podendo ser contornada por \textit{malwares} que esteja camuflado ou que nunca tenha sido identificado, no caso do último, é conhecido como \textit{Zero-Day Malware}. Esta proteção 
...
Existem diversas variantes de \textit{Phishing/Spear-Phishing} porque cada ambiente tem as suas particularidades, e o atacante deve adaptar-se a cada um deles, 
